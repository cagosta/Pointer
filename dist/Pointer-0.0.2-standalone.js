...
/**
 * SeedHq version: "0.0.10" Copyright (c) 2011-2012, Cyril Agosta ( cyril.agosta.dev@gmail.com) All Rights Reserved.
...
/**
 * Pointer version: "0.0.2" Copyright (c) 2011-2012, Cyril Agosta ( cyril.agosta.dev@gmail.com) All Rights Reserved.
 * Available via the MIT license.
...
if ( synchronous ) { // case standalone
    ...
    var Pointer = requirejs( 'Pointer/Pointer' )

    engine.exports( 'Pointer', Pointer )


} else {

    requirejs( [ 'Pointer/Pointer' ], function( Pointer ) {
        engine.exports( 'Pointer', Pointer )
    } )

}
;
define("Pointer/main", function(){});
}());